...
naive_gr_sample_size_plot_df <- naive_gr_sample_size_plot_df %>% mutate(group_rank = (37-group_rank))
...
knowledge_gr_sample_size_plot_df <- knowledge_gr_sample_size_plot_df %>% 
  group_by(sample_num) %>% 
  mutate(group_rank = rank(times_sig_and_greater, ties.method = "max"))
knowledge_gr_sample_size_plot_df <- knowledge_gr_sample_size_plot_df %>% mutate(group_rank = (37-group_rank))
#only show ranks up to 5
...
naive_gr_sample_correlation_plot_df <- naive_gr_sample_correlation_plot_df %>% 
  ...
  mutate(group_rank = rank(times_sig_and_greater, ties.method = "max"))
naive_gr_sample_correlation_plot_df <- naive_gr_sample_correlation_plot_df %>% mutate(group_rank = (37-group_rank))
#only show ranks up to 5
...
knowledge_gr_sample_correlation_plot_df <- knowledge_gr_sample_correlation_plot_df %>% 
  group_by(median_spearman_group) %>% 
  mutate(group_rank = rank(times_sig_and_greater, ties.method = "max"))
knowledge_gr_sample_correlation_plot_df <- knowledge_gr_sample_correlation_plot_df %>% mutate(group_rank = (37-group_rank))
#only show ranks up to 5
...
naive_gr_sample_sum_st_dev_plot_df <- naive_gr_sample_sum_st_dev_plot_df %>% 
  ...
  mutate(group_rank = rank(times_sig_and_greater, ties.method = "max"))
naive_gr_sample_sum_st_dev_plot_df <- naive_gr_sample_sum_st_dev_plot_df %>% mutate(group_rank = (37-group_rank))
#only show ranks up to 5
...
knowledge_gr_sample_sum_st_dev_plot_df <- knowledge_gr_sample_sum_st_dev_plot_df %>% 
  group_by(count_sum_st_dev_group) %>% 
  mutate(group_rank = rank(times_sig_and_greater, ties.method = "max"))
knowledge_gr_sample_sum_st_dev_plot_df <- knowledge_gr_sample_sum_st_dev_plot_df %>% mutate(group_rank = (37-group_rank))
#only show ranks up to 5
...
naive_gr_tissue_plot_df <- naive_gr_tissue_plot_df %>% 
  group_by(tissue) %>% 
  mutate(group_rank = rank(times_sig_and_greater, ties.method = "max"))
naive_gr_tissue_plot_df <- naive_gr_tissue_plot_df %>% mutate(group_rank = (37-group_rank))
#only show ranks up to 5
...
knowledge_gr_tissue_plot_df <- knowledge_gr_tissue_plot_df %>% 
  group_by(tissue) %>% 
  mutate(group_rank = rank(times_sig_and_greater, ties.method = "max"))
knowledge_gr_tissue_plot_df <- knowledge_gr_tissue_plot_df %>% mutate(group_rank = (37-group_rank))
#only show ranks up to 5
...
```{r}
ggsave("../plots/gr_sample_size_naive_heatmap.png", plot = sample_size_fig_naive, height = 8, width = 12)
ggsave("../plots/gr_sample_size_knowledge_heatmap.png", plot = sample_size_fig_knowledge, height = 8, width = 12)
ggsave("../plots/gr_sample_sim_naive_heatmap.png", plot = sample_correlation_fig_naive, height = 8, width = 12)
ggsave("../plots/gr_sample_sim_knowledge_heatmap.png", plot = sample_correlation_fig_knowledge, height = 8, width = 12)
ggsave("../plots/gr_counts_div_naive_heatmap.png", plot = sample_sum_st_dev_fig_naive, height = 8, width = 12)
ggsave("../plots/gr_counts_div_knowledge_heatmap.png", plot = sample_sum_st_dev_fig_knowledge, height = 8, width = 12)
ggsave("../plots/gr_tissue_naive_heatmap.png", plot = tissue_fig_naive, height = 8, width = 12)
ggsave("../plots/gr_tissue_knowledge_heatmap.png", plot = tissue_fig_knowledge, height = 8, width = 12)
```
